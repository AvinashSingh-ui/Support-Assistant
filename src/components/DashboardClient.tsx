  ...
  return (
    <div className='min-h-screen bg-zinc-50 text-zinc-900'>
      ...
      className='fixed top-0 left-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-zinc-200'>
        ...
        <button className='px-4 py-2 rounded-lg border border-zinc-300 bg-black text-white text-sm hover:bg-zinc-100 hover:text-black cursor-pointer transition' onClick={()=>navigate.push("/embed")}>Embed Assistant</button>
        </div>
      </motion.div>
        ...
        >
          ...
          <div className='mb-10'>
           ...
           <div className='mb-10'>
            ...
            <p className='text-zinc-500 text-sm mb-4'>Add FAQs, policies, delivery info and return information etc....</p>
            <div className='space-y-4'>
              <textarea className='w-full h-54 rounded-xl border border-zinc-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-black/80' placeholder={`Example:
                ...
                2.Delivery time: 3-5 business days
                3.Cash on Delivery: Available
                4.Support hours: 9AM-6PM EST`
                } onChange={(e)=>setKnowledgeBase(e.target.value)} value={knowledge} />    
          ...
          <div className='flex items-center gap-5'>
            ...
            disabled={loading}
            className='px-7 py-3 rounded-xl bg-black text-white text-sm font-medium hover:bg-white hover:text-black hover: border hover:border-black transition disabled:opacity-60'
            >
              ...
              className='text-lg font-medium text-emerald-600 flex items-center gap-1'>
               ✓ Saved Settings...
